const conteiner = document.querySelector(".conteiner"),
    musicImg = conteiner.querySelector(".img-area img"),
    musicName = conteiner.querySelector(".song-details .name"),
    musicArtist = conteiner.querySelector(".song-details .artist"),
    ...
    closemoreMusicBtn = conteiner.querySelector("#close");
...
function playMusic() {
    conteiner.classList.add("paused");
    playpauseBtn.querySelector("i").innerText = "pause";
    mainAudio.play();
}

function pauseMusic() {
    conteiner.classList.remove("paused");
...
playpauseBtn.addEventListener("click", () => {
    const isMusicPaused = conteiner.classList.contains("paused");
